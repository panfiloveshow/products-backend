...
class InventoryWarehouse extends Model
{
    ...
    protected $casts = [
        ...
        'real_avg_daily_sales' => 'decimal:2',
        'real_sales_period_days' => 'integer',
        'real_turnover_days' => 'decimal:1',
        'real_days_of_stock' => 'integer',
        ...
        'paid_storage_penalty' => 'decimal:2',
        'paid_storage_fee' => 'decimal:2',
        'paid_storage_from' => 'date',
        'paid_storage_to' => 'date',
