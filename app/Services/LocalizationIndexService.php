...
{
    /**
     * КТР (индекс локализации) — отключён WB с 15.08.2026 (новость WB Partners
     * от 14.08.2026): ИЛ исключён из формулы логистики для складов РФ, вместо
     * него единые КС логистики/хранения (170%, СГТ — 100%) из тарифного фида.
     * Таблица нейтрализована (КТР = 1.00), чтобы весь расчётный контур
     * (job, настройки, кэш) автоматически выдавал ИЛ = 1.0 без изменения логики.
     */
    ...
    public function getKtrByLocalization(float $localizationRate): float
    {
        ...
        // ИЛ отключён с 15.08.2026 — нейтральное значение
        return 1.00;
    }
