...
class OzonPerformanceApiService
{
    ...
    private function aggregateAllSkuPromoOrdersCsv(string $csv): array
    {
        ...
        foreach ($lines as $line) {
            ...
            // Атрибуция по ЗАКАЗАННОМУ товару (колонки SKU/Артикул/Название согласованы между
            // собой), как в кабинете Ozon. «SKU продвигаемого товара» может отличаться (клик по
            // одному товару → покупка другого) — группировка по нему рассинхронит расход с артикулом.
